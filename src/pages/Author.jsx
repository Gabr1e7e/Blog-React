...
const authors = [
  {
    ...
    summary:
      "Découvrez les concepts clés de React, y compris les composants, les props, et l'état.",
    date: "2024-02-20",
    category: "React",
    author: "Alex Durand",
  ...
  },
  {
    ...
    summary:
      "Apprenez comment accélérer le développement de vos interfaces utilisateur avec Tailwind CSS.",
    date: "2024-02-18",
    category: "CSS",
    author: "Chris Martin",
  ...
  },
  {
    ...
    summary:
      "Guide étape par étape pour construire une API REST robuste en utilisant Node.js et Express.",
    date: "2024-02-15",
    category: "Backend",
  ...
  },
  {
    ...
    summary:
      "Explorez en profondeur l'utilisation des hooks pour gérer l'état et le cycle de vie des composants.",
    date: "2024-02-14",
    category: "React",
    author: "Jeanne Dupont",
    authorImageUrl: "https://randomuser.me/api/portraits/women/27.jpg",
    imageUrl:
      "https://developer.okta.com/assets-jekyll/blog/react-hooks/react-hooks-39a66d469d6a86f01f15beea07590a656901be4efd586fead91a92104ec4cd91.png",
  ...
  },
  {
    ...
    summary:
      "Apprenez à utiliser CSS pour ajouter des animations fluides et attrayantes à votre site web.",
    date: "2024-02-13",
    category: "CSS",
    author: "Lucas Bonnet",
    authorImageUrl: "https://randomuser.me/api/portraits/men/23.jpg",
    imageUrl:
      "https://blog.alakmalak.com/wp-content/uploads/2015/04/animation.png",
  ...
  },
  {
    ...
    summary:
      "Un guide pour comprendre et implémenter Redux dans la gestion de l'état d'applications React.",
    date: "2024-02-12",
    category: "React",
    author: "Sarah Lavoine",
    authorImageUrl: "https://randomuser.me/api/portraits/women/39.jpg",
    imageUrl:
      "https://static.wixstatic.com/media/1e24fd_6c5f5b65b3604efdb15c4bdf1031233a~mv2.jpg/v1/fill/w_1000,h_563,al_c,q_85,usm_0.66_1.00_0.01/1e24fd_6c5f5b65b3604efdb15c4bdf1031233a~mv2.jpg",
  ...
  },
  {
    ...
    summary:
      "Découvrez comment utiliser Webpack pour améliorer la vitesse et la performance de votre site web.",
    date: "2024-02-11",
    category: "Outils",
  ...
  },
  {
    ...
    summary:
      "Apprenez à créer des applications mobiles natives performantes avec React Native.",
    date: "2024-02-10",
    category: "Mobile",
  ...
  },
  {
    ...
    summary:
      "Maîtrisez les bases de Docker et apprenez à conteneuriser vos applications efficacement.",
    date: "2024-02-09",
    category: "DevOps",
    author: "Thomas Lefebvre",
    authorImageUrl: "https://randomuser.me/api/portraits/men/7.jpg",
    imageUrl:
      "https://www.1min30.com/wp-content/uploads/2018/04/Embl%C3%A8me-Docker.jpg",
  ...
  },
  {
    ...
    summary:
      "Protégez vos applications Node.js contre les vulnérabilités et les attaques les plus courantes.",
    date: "2024-02-08",
    category: "Sécurité",
    author: "Amandine Bernard",
    authorImageUrl: "https://randomuser.me/api/portraits/women/9.jpg",
    imageUrl:
      "https://miro.medium.com/v2/resize:fit:1400/1*8KnGUEx-K60yXua6UjWczA.jpeg",
      ...
      <div className="container mx-auto px-4 pt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
          {authors.map((author, i) => (
            <Card
              key={0}
              className="max-w-sm mx-auto my-4 bg-[#1A202C] transition duration-500 ease-in-out transform hover:-translate-y-1 hover:shadow-xl"
            >
              <CardBody className="flex flex-col items-center">
                ...
                <Typography
                  variant="h5"
                  className="mb-2 text-center text-[#E11D48]"
                >
                  {author.author}
                </Typography>
              </CardBody>
              <CardFooter
                divider
                className="flex justify-center border-[#E11D48]"
              >
                <Button
                  variant="outlined"
                  className="mt-4 text-white bg-[#E11D48] border-[#E11D48] hover:bg-white hover:border-[#E11D48] hover:text-[#E11D48]"
                >
